...
ブラウザは**すべてのリクエストにOriginヘッダーを追加する。**
リクエストがサーバーに届くと、リクエストのオリジンがリソース取得許可リストに含まれている場合に、サーバーがAccess-Control-Allow-Originヘッダーをレスポンスに追加する。
この情報からブラウザはコンテンツがこのオリジンにアクセスできると判断します。
