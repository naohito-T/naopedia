...
## デザイン収集
[Webデザインの参考になるギャラリーサイト24選【2022年9月版】](https://liginc.co.jp/416443)
...
## テーブル
[テーブル一覧](https://freefrontend.com/css-tables/)

## Grid layoutの初歩
[参考URL](https://codepen.io/jmegs/pen/opbyXg)
...
[ギャラリーサイトとして参考になる   ](https://coco-factory.jp/ugokuweb/wp-content/themes/ugokuweb/data/1-5/1-5.html)

## 購買システム
[参考URL](https://codepen.io/kathykato/pen/gdvjax)
...
[これ導入するだけでreact/nextいける](https://github.com/toinelin/react-locomotive-scroll#getting-started)

## 横スクロール
[CSSだけで](http://kenpicopico.site/?p=943)
[この横スクロールはすごい（Locomotive Scrollを使っている）](https://codepen.io/sfi0zy/pen/PoGvYyy)
